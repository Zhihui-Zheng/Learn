...
def create_env(
    ...
    **kwargs,
    ...
    if "ignore_done" in kwargs:
        ignore_done = kwargs["ignore_done"]
        del kwargs["ignore_done"]
    else:
        ignore_done = True

    if "use_camera_obs" in kwargs:
        use_camera_obs = kwargs["use_camera_obs"]
        del kwargs["use_camera_obs"]
    else:
